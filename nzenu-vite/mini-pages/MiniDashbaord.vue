<template>
  ...
  <div class="bg-white space-y-5 p-5 shadow-lg rounded">
    <div class="grid lg:grid-cols-4 grid-cols-1 gap-2">
      <div class="border p-5 rounded space-y-2 bg-gray-50 shadow">
        <p class="flex items-center space-x-1">
          ...
          ><span>Close Expirations</span>
        </p>
        <div class="flex justify-between">
          <div class="flex items-center space-x-1">
            <span>3 jours</span><span class="font-bold">0</span>
          </div>
          <div class="flex items-center space-x-1">
            <span>15 jours</span><span class="font-bold">0</span>
          </div>
          <div class="flex items-center space-x-1">
            <span>30 jours</span><span class="font-bold">0</span>
          </div>
        </div>
      </div>
      <div class="border p-5 rounded space-y-2 bg-gray-50 shadow">
        ...
        <div class="flex justify-between">
          <div class="text-green-500 font-bold">
            <p><span class="text-green-500">Reussir</span> <span>0</span></p>
          </div>
          <div class="text-yellow-500 font-semibold">
            <p>
              <span class="text-alert d-flex">En Attente</span> <span>0</span>
            </p>
          </div>
          <div class="text-red-500 font-semibold">
            <p>
              <span class="text-danger d-flex align-items-center">annulee</span>
              <span>0</span>
            </p>
          </div>
        </div>
      ...
      <div class="border p-5 rounded space-y-2 bg-gray-50 shadow">
        ...
        <div class="flex justify-center">
          <span class="font-bold text-center">0</span>
        </div>
      </div>
      <div class="border p-5 rounded space-y-2 bg-gray-50 shadow">
        <p class="flex items-center space-x-1">
      ...
      <div class="border p-5 rounded space-y-2 bg-gray-50 shadow">
        ...
        <div class="flex justify-center">
          <span class="font-bold text-center">1</span>
        </div>
      </div>
    </div>
    <div class="bg-gray-100 p-5 rounded"><h1>Autres informations</h1></div>
  </div>
</template>
