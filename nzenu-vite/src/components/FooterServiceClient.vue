<template>
  <section
    class="bg-blue-900 flex justify-center font-semibold text-white space-x-5"
  >
    <div class="lg:flex">
      <div class="p-5">
        <img
          class="w-50 h-50 rounded-full border-2 border-green-200"
      ...
      <div class="p-5" id="supportClientRow2">
        <div class="space-y-8">
          ...
          <p>
            Nous mettons à votre disposition, un support client qualifié, formé
            continuellement pour vous aider dans la mise en œuvre de vos projets
            web.
          </p>
          <div class="lg:flex space-x-8">
            <div class="space-y-5 flex space-x-5">
              <svg
                width="40"
                height="40"
                ...
                aria-hidden="true"
                role="img"
                class="icon w-8 h-8 rounded-full bg-water-leaf-200 text-primary-900 p-1"
                style="
  ...
  <footer>
    <div class="containerm" id="firstfootercontainer">
      <div
        class="lg:grid grid-cols-4 justify-center bg-[#1045A5] text-white font-semibold p-4 space-y-4 space-x-2 lg:px-40"
      >
        <div class="space-y-5">
        ...
        <div class="col-md-12 col-sm-12 col-lg-3">
          ...
          <div class="flex space-x-2">
            ...
            <span>hebergement wordpress</span>
          </div>
          <div class="flex space-x-2">
            <svg
              width="25"
          ...
          <div class="flex space-x-2">
            ...
            >
              ...
              >
                ...
                <path d="m4 8l4.5-4.5H5M10 6l-4.5 4.5H9"></path>
              </g>
            </svg>
           <span>
            Migration d'evenement
           </span> 
          </div>
         <div class="flex space-x-2">
            <svg
        ...
        <div class="col-md-12 col-sm-12 col-lg-3">
          <div class="row">
            <div class="">
              ...
              <div class="flex space-x-2">
                <a
                  href="https://www.facebook.com/nzenuhost"
                  rel="noopener"
                  target="_blank"
                  title="page facebook NzenuHost"
                  class="outline-none"
                  data-v-5eaad1d1=""
                  ><svg
                    width="25"
                    ...
                    aria-hidden="true"
                    role="img"
                    class="icon social bg-[#3a559f]"
                    data-v-5eaad1d1=""
                    style="
                      background: rgb(91, 83, 204);
                      border-radius: 5px;
                      margin: 2px;
                      padding: 5px;
                    "
                ...
                ></a>
                <a
                  href="https://twitter.com/nzenuhost"
                  rel="noopener"
                  target="_blank"
                  title="page twitter NzenuHost"
                  class="outline-none"
                  data-v-5eaad1d1=""
                  ><svg
                    width="25"
                ...
                ></a>
                <a
                  href="https://www.instagram.com/nzenuhost/"
                  rel="noopener"
                  target="_blank"
                  title="page instagram NzenuHost"
                  class="outline-none"
                  data-v-5eaad1d1=""
                  ><svg
                    width="25"
                    ...
                    aria-hidden="true"
                    role="img"
                    class="icon social bg-[#b21674]"
                    data-v-5eaad1d1=""
                    style="
                      background: rgb(202, 50, 139);
                      border-radius: 5px;
                      margin: 2px;
                      padding: 2px;
                    "
                ...
                ></a>
                <a
                  href="https://www.linkedin.com/company/nzenuhost"
                  rel="noopener"
                  target="_blank"
                  title="page linkedin NzenuHost"
                  class="outline-none"
                  data-v-5eaad1d1=""
                  ><svg
                    width="25"
                ...
                ></a>
                <a
                  href="https://www.pinterest.com/nzenuhost/"
                  rel="noopener"
                  target="_blank"
                  title="page pinterest NzenuHost"
                  class="outline-none"
                  data-v-5eaad1d1=""
                  ><svg
                    width="25"
    ...
    <div class="bg-[#172554] flex space-x-3 text-white h-10 p-2 items-center ">
        <p>
            Copyright 2025 <span class="font-semibold">NzenuHost</span>  By <span class="font-semibold">NZENU SARL</span>
        </p>
