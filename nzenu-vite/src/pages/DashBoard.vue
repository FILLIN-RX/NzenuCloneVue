<template>
    <div>
        <nav class="sticky top-0 w-full z-30 lg:px-40">
            <div class="flex justify-between items-center lg:px-10 px-3 bg-blue-800">
                <img class="logo" src="../assets/logo_Nzenuhost1_copie_2_4x-8_rnfqnu.png" alt="Nzenuhost Logo" />
                                ...
                                <div class="py-1 bg-white p-5 rounded-md ring-1 ring-black ring-opacity-5">
                                    ...
                                    <div class="px-2 flex items-center py-2 hover:bg-gray-200 cursor-pointer space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            class="icon block" width="1em" height="1em" viewBox="0 0 14 14">
                                            <g fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round">
                                                <path d="m11 9l2-.5l.5 2"></path>
                                                <path
                                                    d="M13 8.5A6.76 6.76 0 0 1 7 13h0a6 6 0 0 1-5.64-3.95M3 5l-2 .5l-.5-2">
                                                </path>
                                                <path d="M1 5.5C1.84 3.2 4.42 1 7 1h0a6 6 0 0 1 5.64 4"></path>
                                            </g>
                                    ...
                                    <router-link to="/profil"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                                            class="icon w-5 h-5" width="1em" height="1em" viewBox="0 0 24 24">
        ...
        <div class="flex lg:px-40 w-full">
            <div v-show="!mobile" class="py-5 w-1/6 text-black bg-sky-950 h-screen">
                ...
                <div class="text-white flex space-x-2 p-5" :class="{ 'bg-sky-900': $route.path === '/contact' }">
                    ...
                    <div class="col">
                        <router-link to="/contact" class="nav-link text-decoration-none">Contact</router-link>
                    </div>
                </div>
                    ...
                    <div class="col-1">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="4">
                                ...
                                <path d="M12 26L24 4l12 22"></path>
                            </g>
                        </svg>
                    </div>
                    <div class="col">
                        <router-link to="/commande" class="nav-link text-decoration-none">Commandes</router-link>
                    </div>
                </div>
                <div class="text-white flex space-x-2 p-5" :class="{ 'bg-sky-900': $route.path === '/domaine' }">
                    <div class="col-2">
                        <svg width="2em" height="1.3em" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon w-5 h-5" viewBox="0 0 24 24">
                            <path fill="currentColor"
                    ...
                    <div class="col">
                        <router-link to="/domaine" class="nav-link text-decoration-none">Nom de domaine</router-link>
                    </div>
                </div>
                ...
                <div class="text-white flex space-x-2 p-5" :class="{ 'bg-sky-900': $route.path === '/ssl' }">
                    <div class="col-1">
                        <svg width="25" height="35" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon w-5 h-5" viewBox="0 0 496 512">
                            <path fill="currentColor"
                    ...
                    <div class="col">
                        <router-link to="/ssl" class="nav-link text-decoration-none">Certificate SSL</router-link>
                    </div>
                </div>
                <div class="text-white flex space-x-2 p-5" :class="{ 'bg-sky-900': $route.path === '/emailpro' }">
                    ...
                    <div class="col">
                        <router-link to="/emailpro" class="nav-link text-decoration-none">Email Pro</router-link>
                    </div>
                </div>
        ...
        <transition name="mobile-nav">
            <ul v-show="mobileNav" class="dropdown pt-20" @click="mobileNav = false">
                ...
                <li class="text-white flex space-x-2 p-5" :class="{ 'bg-sky-900': $route.path === '/domaine' }">
                    <div>
                        <svg width="2em" height="1.3em" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon w-5 h-5" viewBox="0 0 24 24">
                ...
                <li class="text-white flex space-x-2 p-5" :class="{ 'bg-sky-900': $route.path === '/hebergement' }">
                    <div>
                        <svg width="25" height="35" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon w-5 h-5" viewBox="0 0 24 24">
